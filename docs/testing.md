...
| `TZ=UTC npm run test262:es2015:p1c -- --ledger=tools/test262/es2015-p1c-paths.txt --output=.superpowers/issue-116/p1c/execution.json` | Execute only the reviewed P1C catch-binding ledger (81 roots / 161 variants); writes ignored evidence and never invokes a broad selector                                                                                        |
...
repository-relative output, for example
`TZ=UTC npm run test262:es2015:p1c -- --ledger=tools/test262/es2015-p1c-paths.txt --output=.superpowers/issue-116/p1c/execution.json`.
