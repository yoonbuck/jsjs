...
editions deliberately changed. The 970 classified exclusions break down as:

| Category             | Count | What it means                                                                                                                                                                                                                                                                                                                                                                                     |
| -------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `post-es5-semantics` | 695   | ES5.1 and a later edition genuinely disagree, and this engine implements ES5.1. Every entry cites the clause that makes it right.                                                                                                                                                                                                                                                                 |
...
| --------------- | ----------- | -------- | --------- | ------ | ------- |
| Files           | 53,575      | 11,686   | 11,686    | 11,686 | 21.812% |
| (file, variant) | 102,906     | 22,207   | 22,207    | 22,207 | 21.58%  |
