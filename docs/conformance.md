...
editions deliberately changed. The 642 classified exclusions break down as:
...
| `post-es5-syntax`    | 19    | Syntax outside the supported grammar that the structural parse filter cannot identify alone. |
...
| (file, variant) | 102,910     | 26,858   | 26,858    | 26,858 | 26.099% |

1 of the 53,575 files carry frontmatter this tooling cannot parse; they count as files and expand into no (file, variant) records.
