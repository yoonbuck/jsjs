...
const STALE_APPLIED_P1C_AUTHORITY_SHA256 =
  '9049c137bbd42c82c6277c689d3313928b4fc7ac10aa785bf81d1dd690141897';
// Exact stale applied P1C roadmap authority serialized on the abandoned PR #118
// branch (commit a085d445). Inlined as a durable fixture so the required audit
// tests never depend on a Git ref; its canonicalRoadmapAuthoritySha256 equals
// STALE_APPLIED_P1C_AUTHORITY_SHA256.
const STALE_APPLIED_P1C_AUTHORITY = {
  code: 'P1C',
  issue: 116,
  parentIssue: 70,
  state: 'applied',
  ...
  evidence: [
    ...
    {
      path: 'tools/test262/es2015-p1c-disposition.json',
      sha256:
        '662616db1c184b2475f091ef5c380760afacb298abae8cf6fe7fac0ae528d3bc',
    },
    {
      path: 'tools/test262/es2015-p1c-owner-deltas.json',
      sha256:
        '37517e5f3dc66819f61f5a7bb8ace1921282415f10551d2defa5c3eb0985b570',
    },
    {
      path: 'tools/test262/es2015-p1c-owner-map.json',
      sha256:
        '37517e5f3dc66819f61f5a7bb8ace1921282415f10551d2defa5c3eb0985b570',
    },
    {
      path: 'tools/test262/es2015-p1c-paths.json',
      sha256:
        'd7cd9512d5eb520b1ac9cbbbcc9414381d5de2b1c7de35fa891b5a100352d124',
    },
    {
      path: 'tools/test262/es2015-p1c-promotion.json',
      sha256:
  ...
  protectedOutputs: [
    ...
    },
    {
      ...
      headSha256: null,
      projectionSha256:
        '1898cd103a1039cd10d052ec1d2d23fcfde6871a3dba8af249fb24fa6f502f70',
    },
    {
      ...
      headSha256: null,
      projectionSha256:
        'e247565d30ce17195acbc26f8e18b4344b6af72ff4be507641f647b24162c762',
    },
  ],
  destinations: [
    {
...
function staleAppliedP1CAuthority() {
  return globalThis.structuredClone(STALE_APPLIED_P1C_AUTHORITY);
}
...
export default [
  ...
  },
  {
    ...
    run: () => {
      ...
      const staleAuthority = staleAppliedP1CAuthority();
      assertSame(
  ...
  {
    name: 'ES2015 stale applied P1C authority fixture is inlined and needs no Git ref',
    run: async () => {
      const staleAuthority = staleAppliedP1CAuthority();
      assertSame(
        canonicalRoadmapAuthoritySha256(staleAuthority),
      ...
      const secondClone = staleAppliedP1CAuthority();
      assertSame(secondClone === STALE_APPLIED_P1C_AUTHORITY, false);
      secondClone.issue = 999;
      assertSame(
        canonicalRoadmapAuthoritySha256(staleAppliedP1CAuthority()),
        STALE_APPLIED_P1C_AUTHORITY_SHA256,
      );
    },
  },
