...
editions deliberately changed. The 772 classified exclusions break down as:

| Category             | Count | What it means                                                                                                                                        |
| -------------------- | ----- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| `post-es5-semantics` | 638   | ES5.1 and a later edition genuinely disagree, and this engine implements ES5.1. Every entry cites the clause that makes it right.                    |
...
| --------------- | ----------- | -------- | --------- | ------ | ------- |
| Files           | 53,575      | 11,355   | 11,355    | 11,355 | 21.195% |
| (file, variant) | 102,906     | 21,611   | 21,611    | 21,611 | 21.001% |
